...
<form class="salesforce-form salesforce-referral-form salesforce-form--self-referral" action="<?php echo esc_html($salesforce_instance_url); ?>/servlet/servlet.WebToLead?encoding=UTF-8&orgId=<?php echo esc_attr($salesforce_org_id)?>" method="POST" data-form-type="<?php echo esc_html(SALESFORCE_SELF_REFERRAL_FORM); ?>" novalidate>
  ...
  <input type=hidden name='captcha_settings' value='{"keyname":"Rosecrance","fallback":"true","orgId":"<?php echo esc_html($salesforce_org_id); ?>","ts":""}'>
    ...
    <input id="Category" type="hidden" name="00NVt000000o5oH" value="New Patient">
