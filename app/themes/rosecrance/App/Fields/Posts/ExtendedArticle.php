 ...
 */
class ExtendedArticle extends Layouts
{
    /**
     * Defines fields used within Extended Article post type.
     *
     * @return array
     */
    public function fields()
    {
        return apply_filters(
            'rosecrance/posts/extended-article',
            [
                $this->contentTab(),
                ...
                Group::make(__('Conditions', 'rosecrance'), 'conditions')
                    ...
                    ->fields([
                        Relationship::make(__('Related Conditions', 'rosecrance'), 'related-conditions')
                            ...
                            ->returnFormat('id')
                            ->instructions(__('Select conditions that this extended article relates to.', 'rosecrance')),
                        ]),
                Group::make(__('Services', 'rosecrance'), 'services')
                        ...
                        ->fields([
                            Relationship::make(__('related Services', 'rosecrance'), 'related-services')
                                ...
                                ->returnFormat('id')
                                ->instructions(__('Select services that this extended article relates to.', 'rosecrance'))
                            ]),
                Group::make(__('Programs', 'rosecrance'), 'programs')
                        ...
                        ->fields([
                            Relationship::make(__('Programs', 'rosecrance'), 'related-programs')
                                ...
                                ->returnFormat('id')
                                ->instructions(__('Select one or more programs that this extended article relates to.', 'rosecrance'))
                            ]),
                Group::make(__('Audiences', 'rosecrance'), 'audiences')
                        ...
                        ->fields([
                            Relationship::make(__('Related Audiences', 'rosecrance'), 'related-audiences')
                                ...
                                ->returnFormat('id')
                                ->instructions(__('Select the audience that this extended article relates to.', 'rosecrance')),
                            ]),
            ]
        );
    }
