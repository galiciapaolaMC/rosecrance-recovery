...
namespace Rosecrance\App\Blocks;
...
class RegisterBlocks implements WordPressHooks
{
    ...
    public function registerBlocks()
    {
        ...
        $dir_path   = ROSECRANCE_THEME_PATH_URL . 'blocks/';
        $asset_file = include ROSECRANCE_THEME_DIR . 'blocks/build/index.asset.php';
